...
--function Game.Map.ClearFogOld(pLine, pCol)
--  print("Clear fog")
--  local l,c
...
function Game.Load()
  ...
  Game.TileSheet = love.graphics.newImage("images/tileset.png")
  ...
  print("finished generate the fog of war")
